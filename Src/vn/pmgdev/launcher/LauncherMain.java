...
public class LauncherMain extends AlternativeBase {
	public static GameFolder GAME_FOLDER = new GameFolder(".minecraft");
  public static string version = "1.0.0";
  public static string build = "build 1010";
	private GameLinks GAME_LINKS = new GameLinks("http://localhost/alternative_versions/forge/", "1.19.2-forge-43.1.1.json");
	private LauncherPreferences LAUNCHER_PREFS = new LauncherPreferences("KawaiiLauncher" + version + build, 880, 520, Mover.MOVE);
    ...
    System.out.Println("Detected all version of minecraft, starting the launcher.....");
